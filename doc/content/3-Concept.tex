...
Sprich auf ca. 20 -- 30\,cm Höhe funktioniert die Erkennung bestens und wir haben genügend vertikale Spatzung um Höhenunterschiede festzustellen.
...
\begin{figure}[H]
	...
	\caption[Zustands-Diagramm: Drohne mit Gestensteuerung]{Zustands-Diagramm: Drohne mit Gestensteuerung}
\end{figure}
...
Falls das Problem nicht innerhalb einer bestimmten Zeit behoben wird, soll die Drohne notgelandet werden (stürzt sie ab).
