...
\begin{table}[H]
	...
	%
	\captionabove{Problem: (Init) Hand-Erkennung}
	%
...
\begin{table}[H]
	...
	\rowcolors{1}{tablerowcolor}{tablebodycolor}
	%
	\captionabove{Problem: (Flugbereit) Hand-Erkennung}
	%
	\begin{tabularx}{0.9\textwidth}{ L{0.121\linewidth} | X  }%
		\hline
...
\begin{table}[H]
	...
	\rowcolors{1}{tablerowcolor}{tablebodycolor}
	%
	\captionabove{Problem: (Flug) Hand-Erkennung}
	%
	\begin{tabularx}{0.9\textwidth}{ L{0.121\linewidth} | X  }%
		\hline
...
\begin{table}[H]
	...
	\rowcolors{1}{tablerowcolor}{tablebodycolor}
	%
	\captionabove{Problem: (Flug) Ruckartige Bewegungen}
	%
	\begin{tabularx}{0.9\textwidth}{ L{0.121\linewidth} | X  }%
		\hline
