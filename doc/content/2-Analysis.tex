...
Dazu wird der Gestensensor von Leap Motion verwendet (weitere Informationen zum Sensor sind im \secref{subsec:leapmotion} beschrieben).
...
\begin{figure}[H]
	...
	\caption[System-Überblick: Ist-Zustand]{System-Überblick: Ist-Zustand}
\end{figure}

Beide Systeme sind quelloffen, haben eine aktive Community und funktionieren selbstständig und vollständig.
...
\begin{figure}[H]
	...
	\caption[System-Überblick: Soll-Zustand]{System-Überblick: Soll-Zustand}
\end{figure}
