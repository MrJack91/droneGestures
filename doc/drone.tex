...
\mainmatter
%
% (files loaded with include must not have the suffix .tex)
\input{content/1-WorkDefinition}
\input{content/2-Analysis}
\input{content/3-Concept}
\input{content/4-Proof-of-Concept}
\input{content/5-Testing}
\input{content/6-Summary}
